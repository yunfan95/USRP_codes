...
int UHD_SAFE_MAIN(int argc, char* argv[])
{
    ...
    desc.add_options()
        ...
        ("spb", po::value<size_t>(&spb)->default_value(2.5e5), "samples per buffer")
        ("rate", po::value<double>(&rate)-> default_value(5e5), "rate of outgoing samples")
        ("freq", po::value<double>(&freq)-> default_value(2.946e9) , "RF center frequency in Hz")
        ("lo-offset", po::value<double>(&lo_offset)->default_value(0.0),
            "Offset for frontend LO in Hz (optional)")
        ("gain", po::value<double>(&gain)-> default_value(7), "gain for the RF chain")
        ...
        ("delay", po::value<double>(&delay)->default_value(5.5), "specify a delay between repeated transmission of file (in seconds)")
